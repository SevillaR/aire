...
#'
#' This package can download and retrieve daily data on air quality in Andalusia (Spain),
...
#' are collected automatically, and not validated. Check out Consejeria de Medio Ambiente website for
#' monthly and annual reports based on validated data.
#'
